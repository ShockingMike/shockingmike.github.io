...
/* Both price lists sit here while the site is being built. The build script keeps only the one belonging to
   the copy it is making, so the published English files hold no Vietnamese figure and the published
