...
import { PAL, paperBump, backPaper } from './covers.js';
...
/** The sealed ones: a round hype sticker on the corner of the window, "Coming soon". */
...
function sticker(ctx, S, rec) {
  ...
  font(ctx, 800, r * 0.34, SANS, 'semi-expanded', r * 0.02);
  ctx.fillText('COMING', 0, -r * 0.2);
  ctx.fillText('SOON', 0, r * 0.2);
